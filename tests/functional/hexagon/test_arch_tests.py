...
class ArchTestsUart(QemuSystemTest):
    ...
    def test_l2vic(self) -> None:
        """Tests the L2VIC interrupt controller: register access (enable,
        type, soft interrupt pending), VID capture from L2VIC-delivered
        interrupts, multiple vector delivery, and the fast L2VIC interface.
        """
