...
class ArchTestsUart(QemuSystemTest):
    ...
    def test_interrupts(self) -> None:
        """Tests interrupt delivery: SWI delivery, IMASK masking, CSWI
        clearing, handler arguments, IPEND inspection, delayed delivery,
        IAD clearing after the handler runs, and IASSIGN readback.
        """
    ...
    def test_sys_regs(self) -> None:
        """Tests system registers: SSR initial value, EVB, SYSCFG,
        IMASK, VID, MODECTL, CFGBASE, FRAMEKEY, HTID, SGP, STID, BADVA/
        ELR, DIAG, SSR ASID, and SYSCFG DMT readback/writeback.
        """
