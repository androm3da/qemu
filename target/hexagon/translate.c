...
/*
 * Every exception raised out of translated code is a precise exception: the
 * event number is always HEX_EVENT_PRECISE and the reason is recorded in the
 * cause code.  System mode (hexswi.c) and user mode (cpu_loop()) both decode
 * them the same way.
 */
