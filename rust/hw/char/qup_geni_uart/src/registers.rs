...
// Note: BITS_PER_LONG is typically 64 on 64-bit systems, 32 on 32-bit systems
// For our purposes, we'll use explicit bit widths
...
pub const S_CMD_DONE_EN: u32 = 1 << 0; // Secondary sequencer command done
...
// Hardware parameters
pub const UART_FIFO_DEPTH_WORDS: u32 = 64; // 256 bytes / 4 bytes per word
pub const UART_FIFO_WIDTH_BITS: u32 = 32;
pub const UART_OVERSAMPLING: u32 = 32;
pub const STALE_TIMEOUT: u32 = 160; // Linux default: DEFAULT_BITS_PER_CHAR * STALE_TIMEOUT (10 * 16)
